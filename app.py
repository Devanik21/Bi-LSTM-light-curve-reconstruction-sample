...
# --- MAIN EXECUTION ---
if run_btn:
    # Store all results in session state to prevent rerun issues
    if 'results' not in st.session_state or st.session_state.get('last_run_config') != (selected_name, model_mode, learning_rate, custom_epochs, resolution_factor, time_filter_min):
